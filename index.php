...
<html lang='en'>
    ...
    <body>
        ...
        <nav>
            <a class="nav" href="#home" onclick="show('home')">Home</a>
            <a class="nav" href="#register" onclick="show('register')">Register</a>
            <a class="nav" href="#login" onclick="show('login')">Login</a>
